...
["code"] = "use(Soulrush:752)[!enemy(Swabbie:4743).active]\nuse(Ethereal:998)[enemy(Swabbie:4743).active]\nuse(Dark Talon:1233)\nchange(Gilnean Raven:630)\nuse(Call Darkness:256)\nuse(Nocturnal Strike:517)\nuse(Alpha Strike:504)\nuse(#1)",
},
["team:257"] = {
["name"] = "Aki the Chosen",
["code"] = "change(#2) [self(#1).active & self.dead]\nchange(#3) [enemy(#3).hp<560 & !self(#3).played]\nchange(#2) [self(#3).active]\nuse(Black Claw:919) [enemy(#2).active] \nuse(Leap:364) [self.round>2] \nuse(Bite:110)\nif [weather(Lightning Storm:203)]\n  use(Build Turret:710)\n  use(Repair:278)\nendif \nuse(Build Turret:710) [enemy.ability(Dive:564).usable] \nuse(Metal Fist:384)",
...
["code"] = "use(Sticky Grenade:636) [!enemy.aura(Sticky Grenade:637).exists]\nuse(Screeching Gears:754)\nuse(Launch:645)\nuse(Black Claw:919) [self.round=1]\nuse(Hunting Party:921)\nuse(Leap:364)\nuse(Rampage:124)\nuse(#1)\nstandby\nchange(next)",
},
["team:169"] = {
["name"] = "The Terrible Three",
